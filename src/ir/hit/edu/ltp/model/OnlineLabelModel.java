...
public class OnlineLabelModel
{
	...
	public OnlineLabelModel(FeatureMap fm, float[] parameter)
	{
		...
		this.useNum = new long[parameter.length];
	}
	 ...
	 * descending sort features by used number
	 * some feature's value in parameter is 0 and these feature is useless for
	 * test, just discard them and this can decrease model size significantly
	 * 
	 * @param modelFile
	 * @throws Exception
	 */
	...
	//this anonymous class is used for sorting feature by using number
	class Feature
	{
		public String feat;
		public float value;
	...
	{
		String modelFile = "./model/seg-10000-baseline.model-it-19";
		OnlineLabelModel model = loadModel(modelFile);
		model.writerModel("./model/seg-pku-10000-baseline.model", 0);
	}
}
