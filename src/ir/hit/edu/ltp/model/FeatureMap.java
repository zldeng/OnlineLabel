...
public class FeatureMap
{
	...
	public void initWithStackedInstance(Vector<StackedSegInstance> instanceVec, Vector<String> allLabel, Vector<Pipe> segPipeVec)
			throws Exception
	{
		for (String str : allLabel)
		{
		...
		StringBuffer curLabel = new StringBuffer();
		for (StackedSegInstance inst : instanceVec)
		{
			ArrayList<Integer> featList = new ArrayList<Integer>();
			...
			for (int j = 0; j < inst.sentence.length; j++)
			{
				...
				Vector<String> featVec = inst.extractFeaturesFromStackedInstanceInPosition(j);
