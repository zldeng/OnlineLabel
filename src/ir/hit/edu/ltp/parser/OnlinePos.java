...
public class OnlinePos
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		else if (option.test)
		{
			...
			posTagger.PosForFile(option.testFile, option.resultFile);
		}
	}
	...
	private static void printUsag()
	{
		...
		logger.info("test:  java -cp onlineLabel.jar ir.hit.edu.ltp.parser.OnlinePos -test -model model_file -dicFile dic_file -testFile test_file -result result_file\n");
	}
}
